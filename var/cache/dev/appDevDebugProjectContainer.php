...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8' => 'get1683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8Service',
            '2_683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8' => 'get2683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8Service',
            ...
            'vich_uploader.namer_uniqid.projects_images' => 'getVichUploader_NamerUniqid_ProjectsImagesService',
            'vich_uploader.namer_uniqid.user_images' => 'getVichUploader_NamerUniqid_UserImagesService',
        ...
        $this->privates = array(
            '1_683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8' => true,
            '2_683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8' => true,
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'OpenContribViewBundle', ($this->targetDirs[3].'/app/Resources/OpenContribViewBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'OpenContribViewBundle', ($this->targetDirs[3].'/src/OpenContrib/ViewBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'OpenContribUserBundle', ($this->targetDirs[3].'/app/Resources/OpenContribUserBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'OpenContribUserBundle', ($this->targetDirs[3].'/src/OpenContrib/UserBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'OpenContribProjectsBundle', ($this->targetDirs[3].'/app/Resources/OpenContribProjectsBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'OpenContribProjectsBundle', ($this->targetDirs[3].'/src/OpenContrib/ProjectsBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        return $this->services['assets._version__default'] = new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.0', '%s?%s');
    }
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8']) ? $this->services['1_683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8'] : $this->get1683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8']) ? $this->services['2_683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8'] : $this->get2683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('user_images', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('projects_images', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('user_images', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('user_images', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('projects_images', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('projects_images', $e, $a, $b));
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'opencontribe', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $d, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/OpenContrib/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/OpenContrib/ProjectsBundle/Entity'), 2 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'OpenContrib\\UserBundle\\Entity');
        $c->addDriver($b, 'OpenContrib\\ProjectsBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('OpenContribUserBundle' => 'OpenContrib\\UserBundle\\Entity', 'OpenContribProjectsBundle' => 'OpenContrib\\ProjectsBundle\\Entity', 'VichUploaderBundle' => 'Vich\\UploaderBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_c2b7c35a5518a68b500c3b7062d90550fa9a9edbb7945041b0d26b94396f6f5b');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('OpenContrib\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory(${($_ = isset($this->services['form.factory']) ? $this->services['form.factory'] : $this->get('form.factory')) && false ?: '_'}, 'fos_user_profile_form', 'OpenContrib\\UserBundle\\Form\\ProfileFormType', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('OpenContrib\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('OpenContrib\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('OpenContrib\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('mickael.dicurzio@gmail.com');
        $a->setPassword('root');
        $a->setAuthMode(NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension(${($_ = isset($this->services['assetic.asset_factory']) ? $this->services['assetic.asset_factory'] : $this->getAssetic_AssetFactoryService()) && false ?: '_'}, ${($_ = isset($this->services['templating.name_parser']) ? $this->services['templating.name_parser'] : $this->get('templating.name_parser')) && false ?: '_'}, true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'OpenContribViewBundle', 8 => 'FOSUserBundle', 9 => 'OpenContribUserBundle', 10 => 'AsseticBundle', 11 => 'OpenContribProjectsBundle', 12 => 'VichUploaderBundle', 13 => 'DebugBundle', 14 => 'WebProfilerBundle', 15 => 'SensioDistributionBundle', 16 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/OpenContrib/ViewBundle/Resources/views'), 'OpenContribView');
        $instance->addPath(($this->targetDirs[3].'/src/OpenContrib/UserBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/OpenContrib/UserBundle/Resources/views'), 'OpenContribUser');
        $instance->addPath(($this->targetDirs[3].'/src/OpenContrib/ProjectsBundle/Resources/views'), 'OpenContribProjects');
    ...
    /**
     * Gets the public 'vich_uploader.namer_uniqid.projects_images' shared service.
     *
     * @return \Vich\UploaderBundle\Naming\UniqidNamer
     */
    protected function getVichUploader_NamerUniqid_ProjectsImagesService()
    {
        return $this->services['vich_uploader.namer_uniqid.projects_images'] = new \Vich\UploaderBundle\Naming\UniqidNamer();
    }

    /**
     * Gets the public 'vich_uploader.namer_uniqid.user_images' shared service.
     *
     * @return \Vich\UploaderBundle\Naming\UniqidNamer
     */
    protected function getVichUploader_NamerUniqid_UserImagesService()
    {
        return $this->services['vich_uploader.namer_uniqid.user_images'] = new \Vich\UploaderBundle\Naming\UniqidNamer();
    }
    ...
    /**
     * Gets the private '1_683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get1683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8Service()
    {
        return $this->services['1_683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get2683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8Service()
    {
        return $this->services['2_683f47f5b638b6da34747aea0e4cd7b0f4db28a3cb4b4c4a42d069b69f7a58b8'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('iQvLoDnMuW', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Es-dJYVxGo', 0, 'bktm6zA-n-tes4eLsnQYkA', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9MWTFOYZDX', 0, 'bktm6zA-n-tes4eLsnQYkA', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DPrTiQma6r', 0, 'bktm6zA-n-tes4eLsnQYkA', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5acbdf9bb942e8.88445508');
    }
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, ${($_ = isset($this->services['vich_uploader.metadata_reader']) ? $this->services['vich_uploader.metadata_reader'] : $this->getVichUploader_MetadataReaderService()) && false ?: '_'}, array('projects_images' => array('uri_prefix' => '/uploads/images/projects', 'upload_destination' => ($this->targetDirs[3].'/app/../web/uploads/images/projects'), 'namer' => array('service' => 'vich_uploader.namer_uniqid.projects_images', 'options' => array()), 'directory_namer' => array('service' => NULL, 'options' => NULL), 'delete_on_remove' => true, 'delete_on_update' => true, 'inject_on_load' => false, 'db_driver' => 'orm'), 'user_images' => array('uri_prefix' => '/uploads/images/user', 'upload_destination' => ($this->targetDirs[3].'/app/../web/uploads/images/user'), 'namer' => array('service' => 'vich_uploader.namer_uniqid.user_images', 'options' => array()), 'inject_on_load' => false, 'delete_on_update' => true, 'delete_on_remove' => true, 'directory_namer' => array('service' => NULL, 'options' => NULL), 'db_driver' => 'orm')), '_name');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'OpenContribViewBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/OpenContrib/ViewBundle'),
                    'namespace' => 'OpenContrib\\ViewBundle',
                ),
                'FOSUserBundle' => array(
                    'parent' => NULL,
                ...
                'OpenContribUserBundle' => array(
                    'parent' => 'FOSUserBundle',
                    'path' => ($this->targetDirs[3].'/src/OpenContrib/UserBundle'),
                ...
                'OpenContribProjectsBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/OpenContrib/ProjectsBundle'),
                    'namespace' => 'OpenContrib\\ProjectsBundle',
                ),
            ...
            case 'vich_uploader.mappings': $value = array(
                'projects_images' => array(
                    'uri_prefix' => '/uploads/images/projects',
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/uploads/images/projects'),
                    'namer' => array(
                        'service' => 'vich_uploader.namer_uniqid.projects_images',
                        'options' => array(
                ...
                'user_images' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/uploads/images/user'),
                    'namer' => array(
                        'service' => 'vich_uploader.namer_uniqid.user_images',
                        'options' => array(
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'OpenContribViewBundle' => 'OpenContrib\\ViewBundle\\OpenContribViewBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'OpenContribUserBundle' => 'OpenContrib\\UserBundle\\OpenContribUserBundle',
                'AsseticBundle' => 'Symfony\\Bundle\\AsseticBundle\\AsseticBundle',
                'OpenContribProjectsBundle' => 'OpenContrib\\ProjectsBundle\\OpenContribProjectsBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'opencontribe',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'mickael.dicurzio@gmail.com',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'mickael.dicurzio@gmail.com',
            ...
            'fos_user.model.user.class' => 'OpenContrib\\UserBundle\\Entity\\User',
            'fos_user.profile.form.type' => 'OpenContrib\\UserBundle\\Form\\ProfileFormType',
            ...
            'assetic.bundles' => array(
                ...
                7 => 'OpenContribViewBundle',
                8 => 'FOSUserBundle',
                9 => 'OpenContribUserBundle',
                10 => 'AsseticBundle',
                11 => 'OpenContribProjectsBundle',
